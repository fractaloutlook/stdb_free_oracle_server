...
- Helped Tim reconnect to the new GitHub repository: `https://github.com/fractaloutlook/stdb_free_oracle_server`
- Explained the `main` vs `master` branch naming convention (historical shift around 2020)
- Provided git commands for pushing the documentation folder to GitHub
...
5. Switch to Claude Code for:
   ...
   - Git automation
6. Host the guide on the Oracle free-tier server itself
...
- This is a "side quest" from Tim's main ARG project (FO - fractaloutlook.com)
